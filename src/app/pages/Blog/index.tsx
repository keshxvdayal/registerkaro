...
export default function BlogPage() {
  return (
    <div className="max-w-7xl mx-auto flex flex-col justify-center items-center px-7 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-auto flex gap-3">
            <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm">Money</span>
            <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm">Management</span>
          </div>
        </div>
        <div className="flex flex-col">
          ...
          <div className="mt-auto flex gap-3">
            <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm">Tax Return</span>
            <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm">News</span>
            <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm">Audit</span>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="relative h-64 w-full mb-4 overflow-hidden rounded-lg">
          ...
          <div className="mt-auto flex gap-3">
            <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm">Private Limited Company</span>
            <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm">Customer Success</span>
          </div>
        </div>
        
      </div>
      <Button className="bg-[#1a3c61] mt-10 hover:bg-[#132e4a] font-bold text-white px-6 py-6 md:px-8 md:py-6 rounded-md">
                                Show more Blogs
                            </Button>
    </div>
  )
